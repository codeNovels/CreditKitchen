...
@Component({
  selector: 'app-best-cashback-cards',
  templateUrl: './best-cashback-cards.component.html',
  styleUrls: ['./best-cashback-cards.component.scss']
})
export class BestCashBackCardsComponent implements OnInit {
  ...
  constructor(private http: Http, private matDialog: MatDialog, private location: Location, private activatedRoute: ActivatedRoute, private router: Router) {
    http.get('api/creditCard/?category=cash back')
