...
@Component({
  selector: 'app-best-travel-cards',
  templateUrl: './best-travel-cards.component.html',
  styleUrls: ['./best-travel-cards.component.scss']
})
export class BestTravelCardsComponent implements OnInit {
  ...
  constructor(private http: Http, private matDialog: MatDialog, private location: Location, private activatedRoute: ActivatedRoute, private router: Router) {
    http.get('api/creditCard/?category=travel')
