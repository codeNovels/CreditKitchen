...
@Component({
  selector: 'app-best-student-cards',
  templateUrl: './best-student-cards.component.html',
  styleUrls: ['./best-student-cards.component.scss']
})
export class BestStudentCardsComponent implements OnInit {
  ...
  constructor(private http: Http, private matDialog: MatDialog, private location: Location, private activatedRoute: ActivatedRoute, private router: Router) {
    http.get('api/creditCard/?category=student')
