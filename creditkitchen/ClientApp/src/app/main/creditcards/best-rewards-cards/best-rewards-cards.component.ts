...
@Component({
  selector: 'app-best-rewards-cards',
  templateUrl: './best-rewards-cards.component.html',
  styleUrls: ['./best-rewards-cards.component.scss']
})
export class BestRewardsCardsComponent implements OnInit {
  ...
  constructor(private http: Http, private matDialog: MatDialog, private location: Location, private activatedRoute: ActivatedRoute,private router: Router) {
    http.get('api/creditCard/?category=rewards')
