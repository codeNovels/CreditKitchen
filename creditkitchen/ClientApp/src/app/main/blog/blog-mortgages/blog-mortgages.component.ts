...
@Component({
  selector: 'app-blog-mortgages',
  templateUrl: './blog-mortgages.component.html',
  styleUrls: ['./blog-mortgages.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BlogMortgagesComponent implements OnInit {
  url = "";
  pageId = "";
  catId = "";
  public posts: any[];
