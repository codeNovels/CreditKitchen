...
@Component({
  selector: 'app-blog-banking',
  templateUrl: './blog-banking.component.html',
  styleUrls: ['./blog-banking.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BlogBankingComponent implements OnInit {
  url = "";
  pageId = "";
  catId = "";
  public posts: any[];
