...
@Component({
  selector: 'app-blog-investing',
  templateUrl: './blog-investing.component.html',
  styleUrls: ['./blog-investing.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BlogInvestingComponent implements OnInit {
  url = "";
  pageId = "";
  catId = "";
  public posts: any[];
