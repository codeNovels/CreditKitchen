...
@Component({
  selector: 'app-blog-creditcards',
  templateUrl: './blog-creditcards.component.html',
  styleUrls: ['./blog-creditcards.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BlogCreditcardsComponent implements OnInit {
  url = "";
  pageId = "";
  catId = "";
  public posts: any[];
