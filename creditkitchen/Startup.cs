...
namespace creditkitchen
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "creditkitchen API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            else
            {
                ...
                app.Use(async (context, next) =>
                {
                    ...
                    {
                        var withHttps = "https://www." + context.Request.Host + context.Request.Path + context.Request.QueryString;
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "creditkitchen API V1");
            });
