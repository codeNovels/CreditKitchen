...
namespace creditkitchen.Models
{
    public class CreditCard
    {
        ...
        public string introPurchaseApr { get; set; }
        public string regularPurchaseApr { get; set; }
        public string introBalanceTransferApr { get; set; }
        public string regularBalanceTransferApr { get; set; }
        public string cashAdvanceRate { get; set; }
        public string cashAdvanceFee { get; set; }
        public string lateFee { get; set; }
        public string penaltyApr { get; set; }
        public string balanceTransferFee { get; set; }
        public string foreignTransactionFee { get; set; }
        public string returnPaymentFee { get; set; }
